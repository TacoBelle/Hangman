$(document).ready(function() {
      ...
      var b = GameManager;
           ...
           b.setCurrentWord = function(a) {
            ...
            b.wrongGuess = function(a) {
                  b.resetValues(a);
                  b.newPlayer.setLives();
                  $('.error').show().text("Volve a intentar!");
            }
            ...
            elements.btnSubmitEl.onclick = function() {
                  console.log(currentWord);
                        ...
                        // Verificar la palabra
                                   b.globalPlaceHolder(wordObject);
                                    console.log(currentWord);
                                    var placeholder = wordObject.returnElement();
                                    if (flags.isGuessRight){
                                          ...
                                          //dibujar ahorcado
                                          if (b.newPlayer.getLives() === -5) {
                                                b.gameOver();
                                          }
                                          b.wrongGuess(elements);
               ...
               //   var a = e.toElement.id;
                  for (var key in categoryList.subjects)
                  {
                        if(key === a){
                              ...
                              currentWord= a[Math.floor(Math.random() * a.length)];
                              console.log(b);
                              wordObject = b.setCurrentWord(currentWord);

                        }
                  }
            };

            elements.categorias.addEventListener("click", getPick, false);
            console.log(currentWord);
